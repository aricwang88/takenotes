...
if [ $1 = "start" ]; then
    ...
    if [ $2 = 'all' ]; then
        ...
        /usr/bin/xterm -fg Brown -bg Cyan -cr Yellow -fn 9*15 -e "pushd /home/ehhewng/openair-cn/SCRIPTS/; source ../oaienv; ./run_hss" &
        sleep 1
        /usr/bin/xterm -fg lightgreen -bg Blue -cr red -fn 9*15 -e "pushd /home/ehhewng/openair-cn/SCRIPTS/; source ../oaienv; ./run_spgw" &
        sleep 1
        /usr/bin/xterm -fg LightYellow -bg Orange -cr red -fn 9*15 -e "pushd /home/ehhewng/openair-cn/SCRIPTS/; source ../oaienv; ./run_mme" &
        sleep 1
        /usr/bin/xterm -fg lightgreen -bg LightYellow -cr red -fn 9*15 -e "tailf /tmp/mme.log" &
